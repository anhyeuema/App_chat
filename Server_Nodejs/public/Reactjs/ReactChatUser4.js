...
var CheckUser = React.createClass({
    ...
    EmitMess() {
        e = this;
        var { Username, UserWeb, ArrControlItemMess, ArraySocketIdThoaMan, messenger, imageBase64, pathIma, SoKey } = this.state; //UserWeb = User nhe la thong tin nguoi fung
        e.setState({
          //  messenger: this.refs.txt.value,
            pathIma: 'http://192.168.216.2:2800/hotgirls/8.jpg',
    ...
    // const { ArraySocketIdThoaMan, messenger, imageBase64, pathIma, SoKey } = this.state;
        ...
        if (UserWeb == null || Username ==null) {
            ...
            var dataEmit = {
                ...
                messenger: this.refs.txt.value,
                imageBase64: '',
                pathIma: 'http://192.168.216.2:2800/hotgirls/4.jpg',
            ...
            var UserSendKey = {  //them 1 obj moi vao flatlist
                ...
                pathIma: UserWeb == null ? null : 'http://192.168.216.2:2800/hotgirls/10.jpg',// pathIma,
