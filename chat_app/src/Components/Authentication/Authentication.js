...
export default class Authentication extends Component {
    ...
    DangKy() {
        fetch('http://192.168.0.106:81/App_Chat_Web/chat/Register.php', {
            method: 'post',
            headers: {
    ...
    DangNhap() { //la DangNhap duoc fetch len Login.php
        fetch('http://192.168.0.106:81/App_Chat_Web/chat/Login.php', { //(####)
            method: 'post',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'applicaiton/json'
    ...
    checkLogin() { //checkLogin = checkToken
        ...
        const KieTraToken = async (varToken) => { // gui token voi ten token voi ten token la TOKEN
            fetch('http://192.168.0.106:81/App_Chat_Web/chat/checkToken.php', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'applicaiton/json'
    ...
    refreshToken() {
        ...
        const RefreshToken_time = async (varToken_time) => {
            fetch('http://192.168.0.106:81/App_Chat_Web/chat/refreshToken.php', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
...
/*
        const KieTraToken = async(varToken, NameToken) => { // gui token voi ten token voi ten token la TOKEN
           try {
            await fetch('http://192.168.0.106:81/App_Chat_Web/chat/checkToken.php', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'applicaiton/json'
