                    ...
                    if( Username == ''){ //chua chon ten nguoi chat nguoi nhan tin nhan
                        dataMessenger.map(function (dataEmit, index) {
                         ...
                         //   var index_goc = Nms + index; //gia tri goc tinh tu cai nhan duoc server gui len
                            var UserSendKey = { 
                                key: JSON.stringify(SoKey + ArrdataMessenger.length + index_goc), //do index gia tri bat dau tu 0, index=0 MIN
                            //    key: JSON.stringify(ArrdataMessenger.length + index_goc), //do index gia tri bat dau tu 0, index=0 MIN
                            ...
                            ArrdataMessenger.unshift(UserSendKey);
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <View style={{ flex: 1, backgroundColor: '#fff', flexDirection: 'row' }} >
                    ...
                    <Text style={styles.UserOnline}>uer123: {this.state.Username === null ? null : this.state.Username}</Text>
